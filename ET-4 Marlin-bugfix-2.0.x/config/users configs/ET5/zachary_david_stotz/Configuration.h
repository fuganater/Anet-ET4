...
#define STRING_CONFIG_H_AUTHOR "(davidtgbe, default config. Shupey, ET5)" // Who made the changes.
...
#define TOUCH_SCREEN
  ...
  #define XPT2046_X_CALIBRATION 16923
  #define XPT2046_Y_CALIBRATION   -11353
  #define XPT2046_X_OFFSET         -16
